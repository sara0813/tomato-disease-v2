...
원본 테스트셋(results/internal/<model>/metrics.json) 대비 성능 저하율을 계산한다.
...
from config import CORRUPTED_DIR, CORRUPTION_RESULT_DIR, INTERNAL_RESULT_DIR, TINY_MODELS, model_path  # noqa: E402
...
def main() -> None:
    ...
    for model_name in TINY_MODELS:
        ...
        baseline = load_json(INTERNAL_RESULT_DIR / model_name / "metrics.json")
        ...
        out_dir = CORRUPTION_RESULT_DIR / model_name
